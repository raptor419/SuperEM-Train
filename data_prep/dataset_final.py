...
infFile = "./data/map_pdb_information"
vmd_file="./data/vmd/cross_corr"
sitPath = "./data/map/"
newPath="./data/EM_data/SIM_MAP"
newSitusPath="./data/EM_data/EXP_MAP"
pdbPath="./data/PDB_SAI/"

trimPath = "./data/EM_data/trimmap_new/"
flagPath= "./data/EM_data/flag_dir/"
dataPath = "./data/EM_data/dataset/"
